...
public class MessageController {
    ...
    @Operation(summary = "Get message By Id", description = "Get messages for given Id", tags = {"Message Controller"})
    ...
    @Operation(summary = "Get Messages by userId", description = "Get All Recipes by userId", tags = {"Message Controller"})
    ...
    @Operation(summary = "Get Messages by chatId", description = "Get All Recipes by chatId", tags = {"Message Controller"})
    ...
    @Operation(summary = "Create Message", description = "Create a new Message", tags = {"Message Controller"})
    ...
    @Operation(summary = "Delete Message", description = "Delete message with given Id", tags = {"Message Controller"})
