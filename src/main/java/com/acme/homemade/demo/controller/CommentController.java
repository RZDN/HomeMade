...
public class CommentController {
    ...
    @Operation(summary = "Get comments", description = "Get All comments by publicationId", tags = {"Comment Controller"})
    ...
    @Operation(summary = "Get comments", description = "Get All comments by Id", tags = {"Comment Controller"})
    ...
    @Operation(summary = "Create comments", description = "Create a new comments", tags = {"Comment Controller"})
    ...
    @Operation(summary = "Update comments", description = "Update comments for given Id", tags = {"Comment Controller"})
    ...
    @Operation(summary = "Delete comments", description = "Delete comments with given Id", tags = {"Comment Controller"})
