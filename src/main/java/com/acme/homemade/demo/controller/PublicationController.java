...
public class PublicationController {
    ...
    @Operation(summary = "Get publications", description = "Get All UserChef by userId", tags = {"Publication Controller"})
    ...
    @Operation(summary = "Get publications", description = "Get All UserChef", tags = {"Publication Controller"})
    ...
    @Operation(summary = "Create publications", description = "Create a new publications", tags = {"Publication Controller"})
    ...
    @Operation(summary = "Update publications", description = "Update publications for given Id", tags = {"Publication Controller"})
    ...
    @Operation(summary = "Delete publications", description = "Delete publications with given Id", tags = {"Publication Controller"})
