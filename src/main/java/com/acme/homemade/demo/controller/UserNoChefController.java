...
public class UserNoChefController {
    ...
    @Operation(summary = "Get All userNoChefs", description = "Get All available userNoChefs", tags = {"User - NoChef Controller"})
    ...
    @Operation(summary = "Get userNoChefs By Id", description = "Get userNoChefs for given Id", tags = {"User - NoChef Controller"})
    ...
    @Operation(summary = "Create userNoChefs", description = "Create a new userNoChefs", tags = {"User - NoChef Controller"})
    ...
    @Operation(summary = "Update userNoChefs", description = "Update userNoChefs with given Id", tags = {"User - NoChef Controller"})
    ...
    @Operation(summary = "Delete UserNoChef", description = "Delete UserNoChef with given Id", tags = {"User - NoChef Controller"})
