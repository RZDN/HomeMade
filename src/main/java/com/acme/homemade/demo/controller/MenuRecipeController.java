...
public class MenuRecipeController {
    ...
    @Operation(summary = "Assign Tag to Post", description = "Establishes association between menu and recipe", tags = {"Menu - Recipe Controller"})
    ...
    @Operation(summary = "Remove assignment between Tag to Post", description = "Ends association between menu and recipe", tags = {"Menu - Recipe Controller"})
