...
public class ChatController {
    ...
    @Operation(summary = "Create Chat", description = "Create a new Chat", tags = {"Chat Controller"})
    ...
    @Operation(summary = "Delete Chat", description = "Delete Chat with given Id", tags = {"Chat Controller"})
