...
public class RecipeController {
    ...
    @Operation(summary = "Get Recipes", description = "Get All Recipes by Pages", tags = {"Recipe Controller"})
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get Recipe By Id", description = "Get Recipes for given Id", tags = {"Recipe Controller"})
    ...
    @Operation(summary = "Get Recipes", description = "Get All Recipes by userChefId", tags = {"Recipe Controller"})
    ...
    @Operation(summary = "Create recipe", description = "Create a new recipe", tags = {"Recipe Controller"})
    ...
    @Operation(summary = "Update Recipe", description = "Update Recipe for given Id", tags = {"Recipe Controller"})
    ...
    @Operation(summary = "Delete Recipe", description = "Delete recipe with given Id", tags = {"Recipe Controller"})
