...
public class ChatUserController {
    ...
    @Operation(summary = "Assign Tag to Post", description = "Establishes association between chat and user", tags = {"Chat - User Controller"})
    ...
    @Operation(summary = "Remove assignment between Tag to Post", description = "Ends association between chat and user", tags = {"Chat - User Controller"})
